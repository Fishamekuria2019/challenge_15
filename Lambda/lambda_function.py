...
def validate_data(age, investment_amount):
    ...
    """
    # validate the age, age should be >0
    #since the parameters are integer it's important to cast value
    if age is not None:
        age = parse_int(age)
        if age>=65 and age<0:
    ...
    # validate the investments_amount
...
def get_recommendation(risk_level):
    """
    Returns a buying recommendation based on the current value of the bonds.
    """
    risk_levels= {
        "none": "100% bonds (AGG), 0% equities (SPY) ",
        "low" : "60% bonds (AGG), 40% 40% equities (SPY)",
...
#     * **high:** "20% bonds (AGG), 80% equities (SPY)"
        ...
        #since parameters are integer it's import
...
def recommend_portfolio(intent_request):
    ...
    user_risk = get_recommendation(risk_level)
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            you can get {} bonds or equities for your ${} dollars.
            {}
            """.format(
                age, investment_amount, user_risk
            ),
        },
    )
...
#     # Validates user's input using the validate_data function
#     validate_result = validate_data(age, investment_amount, intent_request)
#     return intent_request["currentIntent"]["slots"]
